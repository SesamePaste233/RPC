...
int main(){
	...
	for (int i = 0;i < img_pts.size();i++) {
		...
		std::cout << "¼ì²éµãÏñ·½Îó²î(ÏñËØ): " << std::setprecision(8) << std::fixed << check_uv(i, 0) - img_pts[i](0) << '\t' << check_uv(i, 1) - img_pts[i](1) << std::endl;
	}
	...
	std::cout << "------------------------------------------------------------" << std::endl;
	std::cout << "¼ì²éµãÏñ·½Îó²î(ÏñËØ): " << std::setprecision(8) << std::fixed << pix_error_x << '\t' << pix_error_y << '\t' << pix_error_xy << std::endl;
	/*
	...
	std::cout << "------------------------------------------------------------" << std::endl;
	std::cout << "¼ì²éµãÎï·½Îó²î: " << std::setprecision(8) << std::fixed << check_error_B << '\t' << check_error_L << '\t' << check_error_H <<std::endl;
	return 0;
	*/
}